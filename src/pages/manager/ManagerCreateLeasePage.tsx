...
import { useAvailableUnitOptionsForManager } from '@/features/leases/hooks/useLeases';
...
export function ManagerCreateLeasePage() {
  const navigate = useNavigate();
  const { data: units, isLoading: unitsLoading } = useAvailableUnitOptionsForManager();
    ...
    <div className="mx-auto max-w-xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              {units && units.length === 0 && !unitsLoading && (
                <p className="text-caption text-muted-foreground">
                  No available units in your assigned properties.
                </p>
              )}
            </div>
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" onClick={() => navigate('/manager/leases')}>
            Cancel
          </Button>
