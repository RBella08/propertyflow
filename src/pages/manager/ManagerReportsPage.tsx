...
import {
  useRevenueReportForManager,
  useOccupancyReportForManager,
  usePaymentSummaryReportForManager,
...
export function ManagerReportsPage() {
  ...
  const { data: revenue, isLoading: revenueLoading } = useRevenueReportForManager(
    startDate,
    endDate
  );
  const { data: occupancy, isLoading: occupancyLoading } = useOccupancyReportForManager();
  const { data: payments, isLoading: paymentsLoading } = usePaymentSummaryReportForManager(
    startDate,
    endDate
  );
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground">Insights across your assigned properties.</p>
      </div>
