...
import { usePaymentSummaryReportForManager } from '@/features/reports/hooks/useReports';
...
export function ManagerPaymentsPage() {
  ...
  const { data: payments, isLoading } = usePaymentSummaryReportForManager(startDate, endDate);
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground">Payments across your assigned properties.</p>
        </div>
        <ExportMenu
          title="Payments"
